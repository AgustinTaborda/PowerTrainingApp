...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Api Backend PowerTrainingApp, PF Henry 17/10/2024 02:55 ')
    .setDescription(
      ...
      '<li>[ESTE COMMIT](https://github.com/AgustinTaborda/PowerTrainingApp/commit/ed543c4e1346a9460304ec2e366c418db7c39972) <br>'+
      '</ul>',
