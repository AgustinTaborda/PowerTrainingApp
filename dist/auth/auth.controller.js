...
let AuthController = class AuthController {
    ...
    async signInWithProvider(profile) {
        try {
    ...
    handleAuthRedirect2(req) {
        if (req.oidc.isAuthenticated()) {
            return { userdata: req.oidc.user, token: req.oidc.idToken };
        }
        else {
            return ('El estado del login en auth.controller.ts es ' +
...
], AuthController.prototype, "authSignIn", null);
__decorate([
    (0, common_1.Post)('signin-provider'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "signInWithProvider", null);
__decorate([
    (0, common_1.Get)('auth0-status'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "handleAuthRedirect2", null);
