...
let ExerciseSeed = class ExerciseSeed {
    ...
    async seedExercises() {
        ...
        await this.dataSource.getRepository(exercise_entity_1.ExerciseEntity).save(exercises);
        return this.dataSource.getRepository(exercise_entity_1.ExerciseEntity).find();
    }
};
exports.ExerciseSeed = ExerciseSeed;
exports.ExerciseSeed = ExerciseSeed = __decorate([
